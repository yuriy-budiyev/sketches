...
android {
    ...
    defaultConfig {
        applicationId = "com.github.yuriybudiyev.sketches.verified"
        minSdk = 24
        targetSdk = 37
        versionCode = 114
        versionName = "1.5.8"
...
dependencies {
    ...
    kspTest(libs.bundles.hilt.compiler)
    ...
    androidTestImplementation(libs.bundles.androidx.test.instrumented)
